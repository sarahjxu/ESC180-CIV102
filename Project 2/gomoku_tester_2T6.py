# hello fellow 2T6s! I'm mrmandarin (Derek Ma 2T4) the maker of this tester. 
# Please make sure the filename and directory is correct (line 9)
# Good luck 2T6s with life! Feel free to say hi (doubt anyone recognizes me) and hope this helps!
...
# my boi Daniel Han needs a gf pls help him find one

import socket, json, contextlib, io, time
from random import *
